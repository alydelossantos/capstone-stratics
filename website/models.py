...
class Data(db.Model):
    ...
    ref_no = db.Column(db.String(100), nullable=True, default="Null")
    date_paid = db.Column(db.String(50), nullable=True, default="Null")
    category = db.Column(db.String(50))
    activation_date = db.Column(db.String(100))
    disconnection_date = db.Column(db.String(100), nullable=True, default="Null")
    reactivation_date = db.Column(db.String(100), nullable=True, default="Null")
