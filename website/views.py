...
def home():
    ...
    abbrenonet = "KCT"
    abbrenotel = "KC"
    if current_user.cname.casefold() == kfull.casefold() or current_user.cname.casefold() == knoinc.casefold() or
       current_user.cname.casefold() == knonet.casefold() or current_user.cname.casefold() == knotel.casefold() or
       current_user.cname.casefold() == knocable.casefold() or current_user.cname.casefold() == abbre.casefold() or
       current_user.cname.casefold() == abbrenoinc.casefold() or current_user.cname.casefold() == abbrenonet.casefold() or
       current_user.cname.casefold() == abbrenotel.casefold():
